...
angular.module('copayApp').config(function(historicLogProvider, $provide, $logProvider, $stateProvider, $urlRouterProvider, $compileProvider, $ionicConfigProvider) {
    ...
    $stateProvider
      ...
      .state('tabs.send.amount', {
        url: '/amount/:recipientType/:toAddress/:toName/:toAmount/:toEmail/:toColor/:isInstantSend/:coin/:fixedUnit',
        views: {
          'tab-send@tabs': {
      ...
      .state('tabs.send.confirm', {
        url: '/confirm/:recipientType/:toAddress/:toName/:toAmount/:toEmail/:toColor/:description/:useSendMax/:isInstantSend/:coin',
        views: {
          'tab-send@tabs': {
